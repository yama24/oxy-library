            ...
            <div class="card">
                <div class="card-header bg-primary text-light">
                    ...
                    <span class="float-end"><button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal"
                            data-bs-target="#addBook" id="addbookbutton">Add
                            Book</button></span>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($books as $b)
                                    <tr>
                                        <th scope="row">{{ $num }}</th>
                                        <td>{{ $b->title }}</td>
                                        <td><img data-bs-toggle="popover" title="{{ $b->title }}" data-bs-html="true"
                    ...
                    <form action="{{ route('editbook') }}" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title" id="title{{ $b->id }}"
                                    value="{{ $b->title }}">
                            </div>
                            <div class="mb-3">
                                <label for="author{{ $b->id }}" class="form-label">Author</label>
                                <input type="text" class="form-control" name="author" id="author{{ $b->id }}"
                                    value="{{ $b->author }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" name="cover"
                                    onchange="displayImage(this,'{{ $b->id }}')" id="cover{{ $b->id }}">
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"
                                name="title" id="title_add" value="{{ old('title') }}">
                            @if ($errors->has('title'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('author') ? 'is-invalid' : '' }}"
                                name="author" id="author_add" value="{{ old('author') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                id="publisher_add" value="{{ old('publisher') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ $errors->has('cover') ? 'is-invalid' : '' }}" type="file"
                                name="cover" onchange="displayImage(this,'_add')" id="cover_add">
                            @if ($errors->has('cover'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cover') }}
                                </div>
