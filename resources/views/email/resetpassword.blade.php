                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="/"
                                            ...
                                            <span
                                                style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;">{{ env('APP_NAME') }}</span>
                                        </a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            Hi {{ $name }},<br>Click link below to reset your password.<br>
                                            <small>url only valid for 5 minutes</small>
                                        </div>
                                    </td>
                                </tr>
                            </table>
